...
const Home = (props) => {
  ...
  return (
    <div className="jumbotron">
      ...
      <p className="text-center"> FrontEnd: React.js, Bootstrap v4, Axios, React Router. </p>
      <p className="text-center"> BackEnd: Node.js, Express, Express Sessions, Body Parser, CORS, bcrypt, Sequelize, MySql</p>
